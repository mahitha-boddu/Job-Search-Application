  ...
  _createClass(JobSearch, [{
    ...
    value: function configureFormListener() {
      ...
      this.searchForm.addEventListener('submit', function (event) {
        ...
        fetch("http://localhost:9000/?search=".concat(search, "&location=").concat(location, "&country=").concat(_this2.countryCode)).then(function (response) {
